...
<?php $__env->startSection('title', 'Régions du Bénin - Culture Bénin'); ?>
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <div class="flex items-center space-x-6">
                    <div class="text-center">
                        <div class="text-2xl font-bold text-benin-green"><?php echo e($regions->total()); ?></div>
                        <div class="text-sm text-gray-500">Régions</div>
                    </div>
                    <div class="hidden md:block w-px h-8 bg-gray-300"></div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-benin-yellow"><?php echo e($stats['totalContenus'] ?? 0); ?></div>
                        <div class="text-sm text-gray-500">Contenus</div>
                    </div>
                    <div class="hidden md:block w-px h-8 bg-gray-300"></div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-benin-red"><?php echo e($stats['languesUniques'] ?? 0); ?></div>
                        <div class="text-sm text-gray-500">Langues</div>
                    </div>
                </div>
                
                <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                    <a href="<?php echo e(route('regions.create')); ?>" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php $__empty_1 = true; $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover-lift group" 
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 mb-6 line-clamp-3">
                        <?php echo e($region->description ?? 'Découvrez la richesse culturelle de cette région.'); ?>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div class="text-center">
                            <div class="text-xl font-bold text-benin-green"><?php echo e($region->contenus_count ?? 0); ?></div>
                            <div class="text-xs text-gray-500">Contenus</div>
                        </div>
                        <div class="text-center">
                            <div class="text-xl font-bold text-benin-yellow"><?php echo e($region->langues_count ?? 0); ?></div>
                    ...
                    <div class="space-y-2 text-sm text-gray-500 mb-6">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-gray-900"><?php echo e(number_format($region->population, 0, ',', ' ')); ?> hab.</span>
                        </div>
                        <?php endif; ?>
                        <?php if($region->superficie): ?>
                        <div class="flex justify-between">
                            <span>Superficie</span>
                            <span class="font-medium text-gray-900"><?php echo e(number_format($region->superficie, 0, ',', ' ')); ?> km²</span>
                        </div>
                        <?php endif; ?>
                    </div>

                    <!-- Languages -->
<?php if($region->langue && $region->langue->count() > 0): ?>
<div class="mb-6">
    <h4 class="text-sm font-medium text-gray-900 mb-2">Langues parlées</h4>
    <div class="flex flex-wrap gap-1">
        <?php $__currentLoopData = $region->langue->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $langue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <span class="bg-benin-green/10 text-benin-green px-2 py-1 rounded text-xs">
            <?php echo e($langue->nom_langue); ?>

        </span>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php if($region->langue->count() > 3): ?>
        <span class="bg-gray-100 text-gray-600 px-2 py-1 rounded text-xs">
            +<?php echo e($region->langue->count() - 3); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel-projects\culture\resources\views/regions/index.blade.php ENDPATH**/ ?>