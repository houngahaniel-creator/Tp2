...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Culture Bénin'); ?> - Plateforme Culturelle</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex justify-center items-center space-x-8 absolute left-1/2 transform -translate-x-1/2">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(Auth::user()->id_role === 1): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link">Administration</a>
...
<?php /**PATH C:\laravel-projects\culture\resources\views/layouts/app.blade.php ENDPATH**/ ?>