...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Authentification'); ?> - Culture Bénin</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-center items-center h-16">
                ...
                <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-3">
                    <img src="<?php echo e(asset('logo.jpg')); ?>" alt="Culture Bénin" class="h-8 w-auto rounded-lg">
...
</html><?php /**PATH C:\laravel-projects\culture\resources\views/layouts/auth.blade.php ENDPATH**/ ?>