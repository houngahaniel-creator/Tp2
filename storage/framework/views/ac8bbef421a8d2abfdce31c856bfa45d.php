...
<?php $__env->startSection('title', 'Tableau de Bord Admin - Culture Bénin'); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border-l-4 border-benin-green"
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['contenus'] ?? 0); ?></p>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border-l-4 border-benin-yellow"
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['utilisateurs'] ?? 0); ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border-l-4 border-benin-red"
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['regions'] ?? 0); ?></p>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border-l-4 border-benin-green"
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['langues'] ?? 0); ?></p>
                        </div>
                        <div class="p-3 bg-benin-green/10 rounded-full">
                            <svg class="w-8 h-8 text-benin-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6" data-aos="fade-right">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <span class="text-sm text-gray-500 dark:text-gray-400"><?php echo e(count($tables)); ?> tables</span>
                    </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 hover:shadow-md transition-all duration-300 border border-gray-200 dark:border-gray-600">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-4 flex-1">
                                        <div class="p-3 bg-<?php echo e($table['color']); ?>-100 dark:bg-<?php echo e($table['color']); ?>-900/30 rounded-xl">
                                            <svg class="w-6 h-6 text-<?php echo e($table['color']); ?>-600 dark:text-<?php echo e($table['color']); ?>-400" 
                                        ...
                                        <div class="flex-1">
                                            <h3 class="font-bold text-gray-900 dark:text-white text-lg"><?php echo e($table['name']); ?></h3>
                                            <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($table['count']); ?> enregistrements</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-2 ml-4">
                                        ...
                                        <button class="p-2 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-600 dark:text-yellow-400 rounded-lg hover:bg-yellow-200 dark:hover:bg-yellow-800/50 transition-all duration-300 transform hover:scale-110 tooltip"
                                                <?php if(isset($table['routes']['index'])): ?> onclick="window.location.href='<?php echo e($table['routes']['index']); ?>'" <?php endif; ?>
                                                title="Voir">
                                        ...
                                        <button class="p-2 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-800/50 transition-all duration-300 transform hover:scale-110 tooltip"
                                                <?php if(isset($table['routes']['create'])): ?> onclick="window.location.href='<?php echo e($table['routes']['create']); ?>'" <?php endif; ?>
                                                title="Créer">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <button class="p-2 bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded-lg hover:bg-red-200 dark:hover:bg-red-800/50 transition-all duration-300 transform hover:scale-110 tooltip"
                                                title="Supprimer"
                                                onclick="showDeleteAlert('<?php echo e($table['name']); ?>')">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="mt-3">
                                    <div class="flex justify-between text-xs text-gray-500 dark:text-gray-400 mb-1">
                                        <span>Capacité</span>
                                        <span><?php echo e($table['count']); ?>/∞</span>
                                    </div>
                                    <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
                                        <div class="bg-<?php echo e($table['color']); ?>-500 h-2 rounded-full transition-all duration-500" 
                                             style="width: <?php echo e(min($table['count'] * 2, 100)); ?>%"></div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6" data-aos="fade-up">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="text-sm text-benin-green font-medium"><?php echo e($recentActivities->count() ?? 0); ?> activités</span>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel-projects\culture\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>